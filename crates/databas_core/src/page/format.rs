...
pub(crate) const CELL_LENGTH_SIZE: usize = 2;
/// Width in bytes of the first-overflow-page field stored in every cell.
pub(crate) const CELL_OVERFLOW_PAGE_ID_SIZE: usize = 8;
/// Fixed-size prefix of a raw leaf cell before its inline payload.
pub(crate) const LEAF_CELL_PREFIX_SIZE: usize =
...
pub(crate) const INTERIOR_CELL_PREFIX_SIZE: usize =
...
pub(crate) const LEAF_HEADER_SIZE: usize = SHARED_HEADER_SIZE;
/// Total header size for an interior page.
pub(crate) const INTERIOR_HEADER_SIZE: usize = SHARED_HEADER_SIZE + 8;
...
impl PageKind {
    ...
    pub(crate) const fn from_node_kind(node_kind: NodeKind) -> Self {
        match node_kind {
    ...
    pub(crate) const fn node_kind(self) -> NodeKind {
        match self {
...
pub(crate) fn read_u16(bytes: &[u8; PAGE_SIZE], offset: usize) -> u16 {
    u16::from_le_bytes([bytes[offset], bytes[offset + 1]])
}

/// Writes a little-endian `u16` into `bytes` at `offset`.
pub(crate) fn write_u16(bytes: &mut [u8; PAGE_SIZE], offset: usize, value: u16) {
    bytes[offset..offset + 2].copy_from_slice(&value.to_le_bytes());
}

/// Reads a sentinel-encoded optional `u16` from `bytes` at `offset`.
pub(crate) fn read_optional_u16(bytes: &[u8; PAGE_SIZE], offset: usize) -> Option<u16> {
...
pub(crate) fn write_optional_u16(bytes: &mut [u8; PAGE_SIZE], offset: usize, value: Option<u16>) {
...
pub(crate) fn read_optional_u64(bytes: &[u8; PAGE_SIZE], offset: usize) -> Option<u64> {
...
pub(crate) fn write_u64(bytes: &mut [u8; PAGE_SIZE], offset: usize, value: u64) {
    bytes[offset..offset + 8].copy_from_slice(&value.to_le_bytes());
}

/// Writes a sentinel-encoded optional `u64` into `bytes` at `offset`.
pub(crate) fn write_optional_u64(bytes: &mut [u8; PAGE_SIZE], offset: usize, value: Option<u64>) {
    write_u64(bytes, offset, value.unwrap_or(u64::MAX));
}

/// Returns the byte offset of `slot_index` within a slot directory.
pub(crate) const fn slot_entry_offset(header_size: usize, slot_index: SlotId) -> usize {
