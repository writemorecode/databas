...
#[derive(Debug)]
#[doc(hidden)]
pub(crate) struct LeafCellFields {
...
impl CellMut<'_, Leaf> {
    ...
    pub(crate) fn value_mut(&mut self) -> PageResult<&mut [u8]> {
